...
public class GoogleCloudPricingCalculatorPage extends AbstractPage {
    ...
    public static final String OS_SOFTWARE_VALUE_SELECTOR = "//md-option//div[contains(text(), '" + createWithProperty().operatingSystem() +"')]";
    ...
    @FindBy(xpath = "//label[text()='Operating System / Software']/parent::md-input-container")
    private WebElement osSoftware;
    @FindBy(xpath = "//label[text()='Provisioning model']/parent::md-input-container")
    private WebElement provisioningModel;
    @FindBy(xpath = "//label[text()='Series']/parent::md-input-container")
    ...
    public GoogleCloudPricingCalculatorPage chooseOSSoftware(){
        osSoftware.click();
        waitUntilVisibility(OS_SOFTWARE_VALUE_SELECTOR).click();
